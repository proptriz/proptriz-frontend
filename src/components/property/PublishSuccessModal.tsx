...
interface PublishSuccessModalProps {
  isOpen:      boolean;
  propertyId:  string;
  /** The title to display in the success panel */
...
/** A single action button row item */
interface Action {
  icon:    string;
  label:   string;
  sub:     string;
  ...
  const actions: Action[] = [
    {
      ...
      primary: true,
      onClick: () => {
        // Replace instead of push so the published wizard is not in the back-stack
        router.replace("/property/add");
      },
    },
    {
      icon:    "👁️",
          ...
          >
            ...
            >
              ...
              <svg
                ...
                fill="none" className="relative z-10"
              >
                <path
                  d="M5 13l4 4L19 7"
                  stroke="#1e5f74"
            ...
            {/* Headline */}
            <h2
              className="text-[22px] font-black text-[#111827] leading-tight mb-1"
            ...
            {/* Property title chip */}
            <div
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full mt-1 mb-2"
